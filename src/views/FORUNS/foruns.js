...
{showCreateForm && (
      <div className="publicacoes_div_princ"><h1 className="publicacoes-title2">Criar Fórum</h1>
        <div className="header">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input type="text" placeholder="inserir nome do fórum" value={nome} onChange={(e) => setNome(e.target.value)} />
          </div>
          <div className="form-buttons">
                <button type="button" className="cancel-button"onClick={handleCancel}>Cancelar</button>
                <button type="button" className="submit-button_maisinfos" onClick={handleSubmit}>Criar</button>
              </div>
        </form>
        </div>
